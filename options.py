...
class TrainOptions():
    def __init__(self):
        ...
        self.parser.add_argument("--data_source", type=str, default='../../RESIDE/ITS', required=False, help="dataset root")
        ...
        self.parser.add_argument("--n_epochs", type=int, default=700, help="number of epochs of training")
        
        # ---------------------------------------- step 5/5 : training... ------------------------------------------------
        self.parser.add_argument("--print_gap", type=int, default=1, help="the gap between two print operations, in iteration")
